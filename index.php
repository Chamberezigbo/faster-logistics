          ...
          <div class="mx-auto" style="width: 100%; max-width: 600px">
               <form action="tracking.inc.php" method="POST">
                    <div class="input-group">
                         <input type="text" name="trackingId" class="form-control border-light" style="padding: 30px" placeholder="Tracking Id" />
                         <div class="input-group-append">
                              <button class="btn btn-primary px-3" type="submit" name="track">
                                   Track & Trace
                              </button>
                         </div>
                    </div>
     ...
     <div class="container">
          <div class="row align-items-center">
               ...
               <div class="col-lg-7">
                    ...
                    <p class="mb-4">
                         At Fast Express Logistics, we redefine the standards of modern logistics. With a relentless commitment to efficiency, reliability, and customer satisfaction, we have established ourselves as a leading name in the transportation and logistics industry.
                    </p>
                    <div class="d-flex align-items-center pt-2">
                         <button type="button" class="btn-play" data-toggle="modal" data-src="https://www.youtube.com/" data-target="#videoModal">
                              <span></span>
                         </button>
                         <h5 class="font-weight-bold m-0 ml-4">
                              Play Video
                         </h5>
                    </div>
               </div>
     ...
     <div class="container">
          <div class="row align-items-center">
               <div class="col-lg-7 py-5 py-lg-0">
                    ...
                    <p class="mb-4">
                         At Fast Express Logistics, we understand that each shipment is unique. To get started on your customized logistics solution, simply fill out the form below.
                         Our expert team will review your requirements and provide you with a tailored quote that aligns with your needs.
                    </p>
                    <div class="row">
                         <div class="col-sm-4">
     ...
     <div class="container">
          <div class="row align-items-center">
               ...
               <div class="col-lg-7 py-5 py-lg-0">
                    ...
                    <p class="mb-4">
                         Our name says it all. We specialize in fast and secure logistics solutions. Whether it's a time-sensitive shipment or delicate cargo, our team is equipped to handle it with utmost care and efficiency.
                    </p>
                    <ul class="list-inline">
                         <li>
                              <h6>
                                   <i class="far fa-dot-circle text-primary mr-3"></i>Best In Industry
                              </h6>
                         </li>
                         <li>
                              <h6>
                                   <i class="far fa-dot-circle text-primary mr-3"></i>Emergency Services
                              </h6>
                         </li>
                         <li>
                              <h6>
                                   <i class="far fa-dot-circle text-primary mr-3"></i>24/7 Customer Support
                              </h6>
                         </li>
                    </ul>
          ...
          <div class="row">
               <div class="col-md-6 mb-5">
                    <div class="position-relative">
                         ...
                         <div class="position-absolute bg-primary d-flex flex-column align-items-center justify-content-center rounded-circle" style="
									width: 60px;
									height: 60px;
									bottom: -30px;
									right: 30px;
                    ...
                    <div class="bg-secondary" style="padding: 30px">
                         ...
                         <p>
                              International shipping offers various methods, including air freight and sea freight. Each method has its advantages and considerations. Air freight is faster but may be costlier, while sea freight is more economical for larger shipments. Consider factors such as delivery time, budget, and the nature of your goods when choosing the appropriate shipping method.
                         </p>
               ...
               <div class="col-md-6 mb-5">
                    ...
                    <div class="bg-secondary" style="padding: 30px">
                         ...
                         <p>
                              Shipping goods internationally can open up exciting opportunities for your business, but it also comes with its fair share of challenges. From customs regulations to logistics coordination, successful international shipping requires careful planning and execution. In this blog post, we'll share some valuable tips to help you navigate the complexities of international shipping and ensure a smooth and hassle-free process.
                         </p>
                         <a class="border-bottom border-primary text-uppercase text-decoration-none" href="">Read More <i class="fa fa-angle-right"></i></a>
                    </div>
               </div>
...
<?php
require('footer.php');
echo isActive('index.php'); // Echo the returned value
